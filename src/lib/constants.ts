...
export const TESTIMONIALS = [
  {
    name: 'Sahan Perera',
    title: 'Owner, Land Cruiser 300',
    quote: 'The ceramic coating they applied to my LC300 is absolutely flawless. The team\'s attention to detail is unmatched. It looks better than when I brought it from the showroom.',
    rating: 5,
    image: '/testimonials/1.jpg',
  },
  {
    name: 'Dilshan Silva',
    title: 'Owner, Defender 110',
    quote: 'I\'ve used detailers all over Colombo, but Auto Elevate is in a different league. The PPF installation was completely invisible and the finish was mirror-perfect.',
    rating: 5,
    image: '/testimonials/2.jpg',
  },
  {
    name: 'Kavindu Jayasuriya',
    title: 'Owner, Toyota Hilux Revo',
    quote: 'They performed a full paint correction and graphene coating on my Hilux. The results were absolutely cinematic. Best investment I\'ve ever made on my vehicle.',
    rating: 5,
    image: '/testimonials/3.jpg',
  },
  {
    name: 'Nuwan Fernando',
    title: 'Owner, Range Rover Autobiography',
    quote: 'Professional from start to finish. They documented every step of the process and the results speak for themselves. The gloss is unbelievable.',
    rating: 5,
    image: '/testimonials/4.jpg',
  },
  {
    name: 'Ashan Gunawardena',
    title: 'Owner, Mercedes-Benz S-Class',
    quote: 'The level of perfectionism at Auto Elevate is crazy. They managed to remove swirl marks that other places told me were permanent. Highly recommended!',
    rating: 5,
